      ...
      <div class="container">
       <!-- Breadcrumbs -->
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
          <h1 class="hero-heading mb-0">회원목록 관리</h1><a class="btn btn-link text-muted" href="#">Archived Messages</a>
        </div>
        <div class="d-flex justify-content-between align-items-end mb-4">
          <select class="selectpicker me-3 mb-3 mb-lg-0" name="bulk" id="form_bulk" data-style="btn-selectpicker" title="Bulk Actions">
           ...
           <div>
		<div id="searchBar" style="display: inline-block; margin: 0 5px; float: right;" class="d-flex justify-content-between align-items-end mb-4">
...
<!--             <label class="form-label me-2" for="form_sort">정렬 기준</label>
            ...
            <div class="row">
              <div class="col-2 col-lg-1 align-self-lg-center py-3 d-flex align-items-lg-center z-index-10">
                <div class="form-check">
                  <input class="form-check-input" id="select_message_0" type="checkbox"><%-- <a class="stretched-link" href="pdetail?id=${list.id}"></a> --%>
              ...
              <div class="col-9 col-lg-4 align-self-center mb-3 mb-lg-0">
                <div class="d-flex align-items-center mb-1 mb-lg-3">
                  <h2 class="h5 mb-0">${list.id}</h2>
                </div>
                <p class="text-sm text-muted">${list.name}</p><%-- <a class="stretched-link" href="pdetail?id=${list.id}"></a> --%>
              </div>
              <div class="col-10 ms-auto col-lg-7">
                <div class="row">
                  <div class="col-md-8 py-3">
                    <p class="text-sm mb-0">${list.tel} &nbsp;&nbsp;|&nbsp;&nbsp; ${list.email} <br> ${list.addr}</p>
                  </div>
                  <div class="col-md-4 text-end py-3">
                    <p class="text-sm">${list.birth}</p>
                     <a href="adelete?id=${Apple.id}">회원탈퇴</a>
                  </div><%-- <a class="stretched-link" href="pdetail?id=${list.id}"></a> --%>
                </div>
              </div>
            </div>
          </div>
